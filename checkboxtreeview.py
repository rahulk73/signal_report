...
IM_CHECKED = "./img/checked.png"     # These three checkbox icons were isolated from
IM_UNCHECKED = "./img/unchecked.png"  # Checkbox States.svg (https://commons.wikimedia.org/wiki/File:Checkbox_States.svg?uselang=en)
IM_TRISTATE = "./img/tristate.png"    # by Marekich [CC BY-SA 3.0  (https://creativecommons.org/licenses/by-sa/3.0)]
